...
public class JumpGamePlus extends JPanel implements ActionListener, KeyListener {
  final int WIDTH = 800;
  ...
  public JumpGamePlus(ScreenFactory screenFactory) {
    ...
    // Remove the JFrame creation from here since JumpGameFrame will handle it
    setPreferredSize(new Dimension(WIDTH, HEIGHT));
    addKeyListener(this);
    setFocusable(true);
  }
  ...
  private void drawStartScreen(Graphics g) {
    ...
    g.drawString(" Jump Game", WIDTH / 2 - 140, HEIGHT / 2 - 50);
